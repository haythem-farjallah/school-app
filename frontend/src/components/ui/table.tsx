...
>(({ className, ...props }, ref) => (
  <thead 
    ref={ref} 
    className={cn(
      "[&_tr]:border-b bg-gradient-to-r from-slate-50 to-blue-50/30 backdrop-blur-sm", 
      className
    )} 
    {...props} 
  />
...
>(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={cn(
      "border-t bg-gradient-to-r from-slate-50 to-blue-50/30 font-medium [&>tr]:last:border-b-0",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ...
    className={cn(
      ...
      "group-data-[state=selected]:text-slate-900",
      "[&:has([role=checkbox])]:pr-0",
      className
    )}
    {...props}
