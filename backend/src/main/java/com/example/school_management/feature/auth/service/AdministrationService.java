...
public class AdministrationService extends AbstractUserCrudService<
    ...
    public AdministrationService(AdministrationRepository repo,
                                 ...
                                 PasswordEncoder enc,
                                 PasswordUtil pw,
                                 ApplicationEventPublisher events, AdministrationMapper mapper1, PasswordEncoder passwordEncoder, AdministrationRepository administrationRepo) {
        super(repo, mapper, enc, pw, events);
        this.mapper = mapper1;
